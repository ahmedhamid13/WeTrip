...
class DestinationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create destination" do
    assert_difference('Destination.count') do
      post destinations_url, params: { destination: { ar_description: @destination.ar_description, ar_name: @destination.ar_name, en_description: @destination.en_description, en_name: @destination.en_name } }
    end
  ...
  test "should update destination" do
    patch destination_url(@destination), params: { destination: { ar_description: @destination.ar_description, ar_name: @destination.ar_name, en_description: @destination.en_description, en_name: @destination.en_name } }
